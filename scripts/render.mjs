...
${slot('apos-contato')}
</main><footer><span>${esc(site.nome).toUpperCase()}${site.registro ? `<br><span class="registro">${esc(site.registro)}</span>` : ''}</span><span>${esc(site.atuacao)}</span><a class="instagram-link" href="${esc(site.instagram.url)}" target="_blank" rel="noopener noreferrer" aria-label="Instagram da ${esc(site.nomeCompleto)} (abre em nova aba)"><svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r=".8" fill="currentColor" stroke="none"/></svg><span>@${esc(site.instagram.usuario)}</span></a></footer>`;
}
